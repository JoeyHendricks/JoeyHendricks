# coding=utf-8
from fenster.common.database.crud import Read
from fenster.common.statistics.helpers import normalize_array, calculate_ecdf

import numpy as np
import pandas as pd


class Measurements(Read):
    ...
    def raw(self) -> tuple:
        ...
        :return: A tuple containing all of the raw data.
        """
